...
# Output Waveform
``
<img width="1189" height="990" alt="download" src="https://github.com/user-attachments/assets/291b5bba-d2eb-4a61-9b5d-c6073f85fc3c" />

<img width="1203" height="590" alt="download" src="https://github.com/user-attachments/assets/46471f37-a60a-4144-9525-9028f9499c00" />
``

# Results
```
The graph has been obtained for both PCM and DM.
```
